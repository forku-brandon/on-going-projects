...
bg_image = Image.open("green.jpeg")
bg_image.fullscreena()
...
labell_me2 = customtkinter.CTkLabel(
             root_tk,
              text="A five digit code has been send to your email please enter the code in  here",
           bg_color='transparent',
           text_color='green',
           font=('serif, Bold', 19),
                      )
...
#               text=" Entry1",
#            bg_color='transparent',
#            text_color='green',            #creating and placing the 'Entry1' label
#            font=('serif, Bold', 19),
#                       )
# labell_me4.place(
#         relx=0.5,
